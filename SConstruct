...
opts.Add(PathVariable('target_path', 'The path where the lib is installed.', 'demo/addons/godotdetour/bin/', PathVariable.PathIsDirCreate))
opts.Add(PathVariable('target_name', 'The library name.', 'libgodotdetour', PathVariable.PathAccept))
